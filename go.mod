...
require (
	...
	github.com/rookie-ninja/rk-boot/v2 v2.2.17
	github.com/rookie-ninja/rk-db/mongodb v1.2.15
...
require (
	...
	golang.org/x/exp/typeparams v0.0.0-20230212135524-a684f29349b6 // indirect
