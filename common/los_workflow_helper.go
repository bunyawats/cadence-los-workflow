...
type (
	// LosHelper class for workflow los helper.
	LosHelper struct {
...
func (h *LosHelper) SetConfigFile(configFile string) {
...
func (h *LosHelper) StartWorkflow(
...
func (h *LosHelper) StartWorkflowWithCtx(
	ctx context.Context,
	options client.StartWorkflowOptions,
	workflow interface{},
	args ...interface{},
...
func (h *LosHelper) SignalWithStartWorkflowWithCtx(ctx context.Context, workflowID string, signalName string, signalArg interface{},
...
func (h *LosHelper) RegisterWorkflow(workflow interface{}) {
	h.RegisterWorkflowWithAlias(workflow, "")
}

func (h *LosHelper) RegisterWorkflowWithAlias(workflow interface{}, alias string) {
...
func (h *LosHelper) RegisterActivity(activity interface{}) {
	h.RegisterActivityWithAlias(activity, "")
}

func (h *LosHelper) RegisterActivityWithAlias(activity interface{}, alias string) {
	registryOption := registryOption{
		registry: activity,
		alias:    alias,
	}
...
func (h *LosHelper) SignalWorkflow(workflowID, signal string, data interface{}) {
	workflowClient, err := h.Builder.BuildCadenceClient()
	if err != nil {
		h.Logger.Error("Failed to build cadence client.", zap.Error(err))
		panic(err)
...
func (h *LosHelper) CancelWorkflow(workflowID string) {
	workflowClient, err := h.Builder.BuildCadenceClient()
	if err != nil {
		h.Logger.Error("Failed to build cadence client.", zap.Error(err))
		panic(err)
...
func (h *LosHelper) registerWorkflowAndActivity(worker worker.Worker) {
